...
public enum Site {
    ...
    QUICKMEME(ImmutableList.of("quickmeme", "qkme"), ImmutableList
            .of("img[id$=img]"), ImmutableList.of("meme_name")), IMGUR(
            ImmutableList.of("imgur"), ImmutableList.of("div.image img")), LIVEMEME(
            ImmutableList.of("livememe"), ImmutableList
                    .of("img[id$=memeImage]")), MEMECREATOR(ImmutableList
            .of("memecreator"), ImmutableList.of("div.left img"));
