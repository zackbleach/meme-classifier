...
//TODO: merge instance?
    ...
    public int hashCode() {
        ...
        result = prime
                * result
                + ((feature == null) ? 0 : feature.getDoubleHistogram()
                        .hashCode());
        return result;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (feature == null) {
            if (other.feature != null)
                return false;
        } else if (!feature.getDoubleHistogram().equals(
                other.feature.getDoubleHistogram()))
            return false;
        return true;
    }
    ...
    public String toString() {
        return "{ID: " + getId() + " | " + "Name: " + name + " | " + "Height: "
    ...
    public String printChildren() {
        if (children[0] != null && children[1] != null) {
            return " >> " + children[0].getId() + " " + children[1].getId();
        }
        return "";
    }
