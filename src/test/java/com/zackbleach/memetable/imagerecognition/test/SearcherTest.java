...
public class SearcherTest {
    ...
    public void accuracyPhilosoraptor() throws IOException, URISyntaxException {
        Assert.assertTrue(classificationUtils.classifyMemeFromPath(PHILOSORAPTOR_IMAGE).getMeme() == Meme.PHILOSORAPTOR);
    }

    @Test
    public void accuracyInternetWife() throws IOException, URISyntaxException {
        Assert.assertTrue(classificationUtils.classifyMemeFromPath(INTERNET_WIFE_IMAGE).getMeme() == Meme.INTERNET_WIFE);
    }

    @Test
    public void accuracyInsanityWolf() throws IOException, URISyntaxException {
        Assert.assertTrue(classificationUtils.classifyMemeFromPath(INSANITY_WOLF_IMAGE).getMeme() == Meme.INSANITY_WOLF);
    }
